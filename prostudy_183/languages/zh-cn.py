...
"Can't delete task while counting down": "Can't delete task while counting down",
...
'Please select a task to start': 'Please select a task to start',
'Plugins': 'Plugins',
'Powered by': '基于下列技术构建：',
'Preface': 'Preface',
